...
### For Docker provisioning only
- `INSTALL_DOCKER="y"`
- `APPROVE_IP="y"`
- `ENDPOINT="publicip.com"`
- `TUN_NUMBER="11"` # to use static interface for firewall on host machine
- `IP_CHOICE="2"`
- `IP_RANGE="10.88.88.0"`
- `DISABLE_DEF_ROUTE_FOR_CLIENTS="y"`
- `CLIENT_TO_CLIENT="y"`
- `SET_MGMT="management 0.0.0.0 2080"`

### Use it for installing Docker packages
- `BUILD_DOCKER="y"`
